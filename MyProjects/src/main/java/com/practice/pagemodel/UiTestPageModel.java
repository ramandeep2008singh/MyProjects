...
public class UiTestPageModel {
	...
	/**
	 * Locator for Label: "Welcome to your account. Here you can manage all of your personal information and orders."
	 */
	...
	/**
	 * Locator for Checkbox: "I agree to the terms of service and will adhere to them unconditionally. (Read the Terms of Service)"
	 */
