...
public class ExtentManager {
	...
	// getInstance is a method inside ExtentReports class and we need to provide
	// the path in which reports will be generated
	public static ExtentReports getInstance(String reportPath) {
		if (extent == null) {
			// if entent object is null then, generate report folder with below
			// name.html
			String fileName = "GfkReport.html";
			Date d = new Date();
